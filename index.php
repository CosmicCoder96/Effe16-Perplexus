...
if(!$fbuser){
	$fbuser = null;
	$loginUrl = $facebook->getLoginUrl(array('redirect_uri'=>"http://effe.org.in/Perplexus/",'scope'=>$fbPermissions));
    ...
    <div class = "col-lg-6">
      <div class="type-wrap">
            <div id="typed-strings">
                <span>You have reached perplexus.</span>
      ...
      <input type = "button" id = "mbtn" class = "btn btn-success" value = "Begin"/>

 
    </div>
  </div>
</div>
 <div id = "bottomwrapper"><img src = "images/bottom.png" class = "bottom"><img src = "images/bottom.png" class = "bottom"><img src = "images/bottom.png" class= "bottom"><img src = "images/bottom.png" class= "bottom"></div>';
}else{
