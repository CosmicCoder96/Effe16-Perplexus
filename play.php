                    ...
                    <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-bank"></i> How To Play<i class="fa fa-angle-down rotate-icon"></i></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="https://www.facebook.com/events/301407130224726/?active_tab=discussion" class="waves-effect">Hints</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li><a href="http://effe.org.in/" class="collapsible-header waves-effect "><i class="fa fa-money"></i> Effervescence</i></a>
                    </li>
...
<div id="about" class="overlay light">
    ...
    <div class="popup">
        ...
        <div class="content" >
            ...
            <p>Played the the real life version of treasure hunt, but let’s face it, it’s unfair 😉</p>
            ...
            <p>Perplexus is a full fledged dedicated dedicated to online treasure hunt.</p>
...
<div id="contact" class="overlay light">
    ...
    <div class="popup">
        ...
        <div class="content" >
            <ol>
            <li>Shubham Padia - +91 9918463021 - <a href = "https://www.facebook.com/padiashubham">fb</a></li>
            <li>Abhinav Khare - +91 8989118413 - <a href="https://www.facebook.com/khareabhinav">fb</a></li>
            </ol>
        </div>
    </div>
</div>
